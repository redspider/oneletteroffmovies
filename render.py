...
cur.execute("SELECT qname, author_name, author_id, profile_image, movie, count FROM movies JOIN entries ON movies.best = entries.id WHERE count > 1 AND movie != '' ORDER BY movies.count DESC LIMIT 100")
